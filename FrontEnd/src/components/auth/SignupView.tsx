...
export function SignupView() {
  ...
  return (
    <div className="min-h-screen max-h-screen flex flex-col items-center bg-accent font-sans overflow-hidden">
      <div className="flex flex-col h-screen items-center justify-center px-6 lg:px-20 bg-accent">

        
          <form onSubmit={handleSignup} className="flex flex-col gap-3 bg-card p-5 rounded-2xl shadow-xl">
            <div className="text-center p-3 flex flex-col gap-2">
              <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Create an account</h2>
              <p className="text-slate-500">Start your journey towards professional focus</p>
            </div>
            <div className="">
              <label className="text-sm font-semibold text-slate-700" htmlFor="name">Username</label>
              <Input 
                type="text" 
                id="name" 
